...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">PG12 - 2023; SPOC: Akhil</h1>
    <h2 style="color: teal;text-align:center;">Window Cleaning Unit</h2>
    
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      <tr/><tr/>
      <tr/><tr/>
      <tr>
        <td style="text-align:left;font-size:25px"><b>Cleaner:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="180" value="90" class="slider" id="Cleaner" oninput='sendButtonInput("Cleaner",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/>
    ...
    <script>
      ...
      function enableDisableButtonsSliders(button)
      {
        if(button.id == "Play")
        {
          ...
          document.getElementById("Cleaner").style.pointerEvents = disabled;
